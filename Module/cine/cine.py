...
var = [{'place_id': 60799619, 'licence': 'Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright',
        ...
        'display_name': 'Parking Grand Place - Entrée piéton (Cinéma), Grand Place, Bruyères, Louvain-la-Neuve, Ottignies-Louvain-la-Neuve, Nivelles, Brabant wallon, Wallonie, 1348, België / Belgique / Belgien',
...
var2 = [{'place_id': 118583596, 'licence': 'Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright',
         'osm_type': 'way', 'osm_id': 71444739, 'boundingbox': ['50.7001144', '50.7003976', '4.590172', '4.5906048'],
         'lat': '50.7002958', 'lon': '4.590404271098004',
         'display_name': "Cinema 4D, Boulevard de l'Europe, Limal, Wavre, Nivelles, Brabant wallon, Wallonie, 1300, België / Belgique / Belgien",
        ...
        {'place_id': 325329544, 'licence': 'Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright',
         ...
         'display_name': 'Cinéma Vendôme, 18, Chaussée de Wavre - Waverse Steenweg, Matongé, Ixelles - Elsene, Brussel-Hoofdstad - Bruxelles-Capitale, Région de Bruxelles-Capitale - Brussels Hoofdstedelijk Gewest, 1050, België / Belgique / Belgien',
...
var3 = [{'place_id': 3113491, 'licence': 'Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright',
         ...
         'display_name': 'Ciné Centre, 91, Avenue de Merode, Fond du Patch, Bourgeois, Rixensart, Nivelles, Brabant wallon, Wallonie, 1330, België / Belgique / Belgien',
...
var_namur = [
    ...
    {'place_id': 226866051, 'licence': 'Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright',
     ...
     'display_name': 'Centre Culturel - Cinéma Royal, 55, Rue du Moulin, Gembloux, Namur, Wallonie, 5030, België / Belgique / Belgien',
    ...
    {'place_id': 226813198, 'licence': 'Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright',
     ...
     'display_name': 'Cinéma de Gedinne, 11, Rue de la Croisette, Gedinne, Dinant, Namur, Wallonie, 5575, België / Belgique / Belgien',
     'class': 'amenity', 'type': 'cinema', 'importance': 0.11100000000000002,
     'icon': 'https://nominatim.openstreetmap.org/ui/mapicons//tourist_cinema.p.20.png',
