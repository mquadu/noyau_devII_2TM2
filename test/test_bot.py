...
class TestBot(unittest.TestCase):
    ...
    def test_get_help(self):
        self.assertEqual(len(Bot(Request("/help"), self.true_command_list).get_help(HELP_FILE)), 911)
    ...
    def test_process_request(self):
        ...
        self.assertEqual(len(Bot(Request("/resto gembloux"), self.true_command_list).process_request(Request("/resto gembloux").get_message(self.true_command_list))), 79)
